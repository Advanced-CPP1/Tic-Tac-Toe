    ...
    , ui(new Ui::TicTacToe)
{
    ...
    game_music->setSource(QUrl::fromLocalFile("qrc:/media/game_music.mp3"));
    game_music->setAudioOutput(audioOutput);
...
void TicTacToe::on_grid_1_clicked()
{
    ...
    if (player == 'X') {
     ...
     if (grid_1_pressed == true && grid_2_pressed == true && grid_3_pressed == true && grid_4_pressed == true && grid_5_pressed == true && grid_6_pressed == true
             && grid_7_pressed == true && grid_8_pressed == true && grid_9_pressed == true) {
         ui->winner_label->setText(QString("Draw!"));
     }
